...
public class SunshineService extends IntentService {
     ...
     */
    private void insertWeatherDataFromJsonIntoDB(String forecastJsonStr, String locationSetting)
    {
    ...
    private URL buildURL(String city_id)
    {
        URL url = null;
    ...
    private String downloadWeatherData(String city_id)
    {
        HttpURLConnection urlConnection = null;
        BufferedReader reader = null;
        String forecastJsonStr = null;
        URL url = buildURL(city_id);
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String prefLocKey = this.getString(R.string.pref_location_key);
        String prefLocDefaultValue = this.getString(R.string.pref_location_default_value);
        ...
        String forecastJsonStr = null;
        forecastJsonStr = downloadWeatherData(cityLocation);

        if (forecastJsonStr != null)
        {
            insertWeatherDataFromJsonIntoDB(forecastJsonStr, cityLocation);
        }
